/*
 ...
 It connects to an MQTT server then:
  ...
  - If the first character of the topic "inTopic" is an 1, switch ON the Arduino Led,
    else switch it off
...
char ssid[] = "MQTT_TEST";            // your network SSID (name)
char password[] = "raspberry";        // your network password
